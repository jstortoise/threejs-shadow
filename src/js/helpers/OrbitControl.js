...
class OrbitControl extends THREE.EventDispatcher {
    constructor(object, domElement, localElement) {
        ...
        this.zoomCamera = function () {
            ...
            var factor = 1.0 + ( dollyEnd - dollyStart ) * this.userZoomSpeed;
            scale *= factor;
        ...
        this.update = function () {
            ...
            if (scale != 1) {
                ...
                scaleTween = new TWEEN.Tween(currentScale).to({scale: scale}, 200).onUpdate(()=> {
        ...
        function onMouseMove(event) {
            ...
            if (state === STATE.ROTATE) {
                ...
                rotateTween = new TWEEN.Tween(rotateStart).to(rotateEnd, 200).easing(TWEEN.Easing.Quadratic.InOut).onUpdate(()=> {
                ...
                panTween = new TWEEN.Tween(panStart).to(panEnd, 200).easing(TWEEN.Easing.Quadratic.InOut).onUpdate(()=> {
                    scope.pan(panEnd.clone().sub(panStart).multiplyScalar(0.01));
                }).start();
        ...
        function onMouseWheel(event) {
            ...
            if (!isMouseOver || scope.enabled === false || scope.noZoom === true) return;
        ...
        function touchend(event) {
            ...
            if (scope.enabled === false || !touchIsStarted_) {
                return;
            }
