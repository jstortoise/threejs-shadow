 ...
 */
class LeanToRoof extends THREE.Object3D {
    /**
     * Creates roof object
     ...
     */
    constructor(shedWidth, shedDepth, shedHeight) {
        super();
        let self = this;
        let planes_=[];
        ...
        let vertices_ = [
            ...
            shedWidth * 0.5, -shedWidth * 2.5 / 12, shedDepth * 0.5 + dPadding, //1
            shedWidth * 0.5, -shedWidth * 2.5 / 12, -shedDepth * 0.5 - dPadding,//2
