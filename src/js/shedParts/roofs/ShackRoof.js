 ...
 */
class ShackRoof extends THREE.Object3D {
    /**
     * Creates roof object
     ...
     * @param shiftHorizontally If set, adds 5cm from the each side, making roof little wider.
     *          It's needed to cover horizontal trim on the begining of the gable (truss). @default - true
     */
    constructor(shedWidth, shedDepth, roofHeight, depthPadding = 20, widthPadding = 10, shiftHorizontally = true) {
        super();
        let self = this;
        let planes_ = [];
        ...
        let xShift = shiftHorizontally ? 5 : 0;
        let vertices_ = [
            -shedWidth * 0.5 - xShift, 0, shedDepth * 0.5 + depthPadding,    //0
            0, roofHeight, shedDepth * 0.5 + depthPadding,              //1
            shedWidth * 0.5 + xShift, 0, shedDepth * 0.5 + depthPadding,     //2
            -shedWidth * 0.5 - xShift, 0, -shedDepth * 0.5 - depthPadding,   //3
            0, roofHeight, -shedDepth * 0.5 - depthPadding,             //4
            shedWidth * 0.5 + xShift, 0, -shedDepth * 0.5 - depthPadding,    //5
        ];
