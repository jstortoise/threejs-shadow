 ...
 */
class BarnRoof extends THREE.Object3D {
    /**
     * Creates roof object
    ...
    constructor(shedWidth, shedDepth, roofHeight) {
        ...
        let dPadding = 20;
        let hPadding = 10;
        let diagonal = Math.sqrt(2 * Math.pow(hPadding, 2));
        ...
        let vertices_ = [
            -shedWidth * 0.5 - 5, 0, shedDepth * 0.5 + dPadding,                       //0
            -shedWidth * relatives.w, roofHeight * relatives.h, shedDepth * 0.5 + dPadding,   //1
            0, roofHeight, shedDepth * 0.5 + dPadding,                         //2
            shedWidth * relatives.w, roofHeight * relatives.h, shedDepth * 0.5 + dPadding,    //3
            shedWidth * 0.5 + 5, 0, shedDepth * 0.5 + dPadding,                        //4
            -shedWidth * 0.5 - 5, 0, -shedDepth * 0.5 - dPadding,                      //5
            -shedWidth * relatives.w, roofHeight * relatives.h, -shedDepth * 0.5 - dPadding,  //6
            0, roofHeight, -shedDepth * 0.5 - dPadding,                        //7
            shedWidth * relatives.w, roofHeight * relatives.h, -shedDepth * 0.5 - dPadding,   //8
            shedWidth * 0.5 + 5, 0, -shedDepth * 0.5 - dPadding,                       //9
        ];
        ...
        this.add(metalRoof);
        this.add(borders1);
        borders1.position.setZ(shedDepth * 0.5 + dPadding + 2);
        let borders2 = new THREE.Object3D();
        _.each(borders1.children, (child)=> {
            borders2.add(child.clone());
        });

        borders2.position.setZ(-shedDepth * 0.5 - dPadding - 2);
        ...
        let trim = new SimpleTrim(tools.in2cm(4), shedDepth + dPadding * 2, trimAngleVector.angleTo(new THREE.Vector3(-1, 0, 0)));
        ...
        let trim2 = new SimpleTrim(tools.in2cm(4), shedDepth + dPadding * 2, trimAngleVector.angleTo(trimAngleVector2));
        ...
        let trim3 = new SimpleTrim(tools.in2cm(4), shedDepth + dPadding * 2, trimAngleVector.angleTo(trimAngleVector2));
        ...
        let trim4 = new MetalTrim(tools.in2cm(4), shedDepth + dPadding * 2 + 6, trimAngleVector.angleTo(new THREE.Vector3(-1, 0, 0)));
        trim4.position.setY(roofHeight + 3);
        this.add(trim4);
        trim4.visible = false;
